...
public class GameJFrame extends JFrame implements KeyListener, ActionListener {
    ...
    //定义一个变量，表示当前展示图片的路径
    String path = "jigsaw_game/image/animal/animal3/";
    ...
    JMenuItem replayJMenuItem = new JMenuItem("重新游戏");//创建菜单条目对象 "重新游戏" "重新登录" "关闭游戏"
    JMenuItem reLoginJMenuItem = new JMenuItem("重新登录");
    JMenuItem closeJMenuItem = new JMenuItem("关闭游戏");
    JMenuItem accountJMenuItem = new JMenuItem("公众号");//创建菜单条目对象 "公众号"
    ...
    private void initImage() {
        ...
        //添加背景图片在下层
        JLabel jLabelBg =new JLabel(new ImageIcon("jigsaw_game\\image\\background.png"));
    ...
    private void initJMenuBar() {
        JMenuBar jMenuBar = new JMenuBar(); //创建菜单栏对象jMenuBar

        JMenu functionJMenu = new JMenu("功能");//创建菜单按钮对象 "功能" "关于我们"
        ...
        functionJMenu.add(replayJMenuItem);//添加"功能"按钮下的菜单条目
        functionJMenu.add(reLoginJMenuItem);
        functionJMenu.add(closeJMenuItem);

        aboutJMenu.add(accountJMenuItem);//添加"关于我们"按钮下的菜单条目

        jMenuBar.add(functionJMenu);//将按钮添加到菜单栏
        jMenuBar.add(aboutJMenu);

        this.setJMenuBar(jMenuBar);//在界面设置菜单栏
    }
...
//            System.out.println("公众号");
            ...
            //创建一个管理图片的容器对象
            JLabel jLabel = new JLabel(new ImageIcon("jigsaw_game\\image\\about.png"));
